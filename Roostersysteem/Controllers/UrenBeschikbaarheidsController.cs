...
{
    public class UrenBeschikbaarheidsController : Controller
    {
        private RoosterDB db = new RoosterDB();

        // GET: UrenBeschikbaarheids
        public ActionResult Index()
        {
            return View(db.UrenBeschikbaarheids.ToList());
        }

        // GET: UrenBeschikbaarheids/Details/5
        ...
        // GET: UrenBeschikbaarheids/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: UrenBeschikbaarheids/Create
        ...
        // GET: UrenBeschikbaarheids/Edit/5
        ...
        // POST: UrenBeschikbaarheids/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: UrenBeschikbaarheids/Delete/5
        ...
        // POST: UrenBeschikbaarheids/Delete/5
