...
{
    public class UrenCollegesController : Controller
    {
        ...
        // GET: UrenColleges/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: UrenColleges/Create
